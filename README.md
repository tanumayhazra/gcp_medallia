#pj-cloud-order-history-service
This Application will read order details from pubsub topic and will store the details in cloud datastore. The Rest point gives the ways to fetch the details as well.
...
The application.properties contain the configuration for Project ID, Topic and Subscriber name. This should be configured accordingly before deploying
